(function init() {
    ...
    editor1.create({drop_zone: drop_zone1, width: drop_zone1.offsetWidth, height: drop_zone1.offsetHeight});
    ...
    editor2.create({drop_zone: drop_zone2, width: editor_zone2.offsetWidth, height: editor_zone2.offsetHeight});
